        ...
        for s in sentences:
            ...
            for l in lexems:
                ...
                for i in range(morphCount):
                    if morph[i].normal_form == l.lower() or len(morph[i].normal_form)//len(l.lower()) < 3 and {'UNKN'} not in morph[i].tag:
